...
export default class Robot {
    ...
    update() {
        ...
        const moveForce = 120  // Incrementado de 80 a 120 para mayor fuerza
        const turnSpeed = 4.0  // Incrementado de 2.5 a 4.0 para giros más rápidos
        let isMoving = false

        // Limitar velocidad si es demasiado alta
        const maxSpeed = 25  // Incrementado de 15 a 25 para mayor velocidad máxima
        ...
        if (keys.space && this.body.position.y <= 0.51) {
            this.body.applyImpulse(new CANNON.Vec3(forward.x * 1.2, 4.5, forward.z * 1.2))  // Salto más potente
